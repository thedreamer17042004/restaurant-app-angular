...
export class RestaurentDashComponent implements OnInit {
  // để tạo ra một khâu xử lý đối tượng form chính 
  // FormGroup is used to create a kind of object that gets updated with your input field values.
  //  In your example, this.formValue is tied to a form in your html file.
  formValue!:FormGroup
